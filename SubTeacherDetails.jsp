...
<div class="container">
    ...
    <input type="text" placeholder="Enter Teacher Id" name="Tid" ID="TT" required>
    ...
    function add()
    {
        document.getElementById("teacher").action="AddSubTeacherOp.jsp";
         document.getElementById("teacher").submit();
    }
    
    function search()
    {
        document.getElementById("teacher").action="SearchSubTeacherOp.jsp";
         document.getElementById("teacher").submit();
    }
