  ...
  .cancelbtn, .signupbtn {
    ...
    <body>
        ...
        <%
            ...
            int p= ps.executeUpdate("update SUBADMINTEACHERTBL set TEACHERNAME='"+TNAME+"',CONTACTNO='"+CONTACT+"',EMAIL='"+EMAIL+"',EXPERIENCE='"+EXP+"',QUALIFICATION='"+QUAL+"',SPECIALIZATION='"+SPL+"' where TEACHERID='"+TID+"'");
            if(p!=0)
            {
